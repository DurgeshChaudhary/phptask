                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li><a href="#">About Us</a>
                                                <ul>
                                                    ...
                                                    <li><a href="{{url('project.html')}}">Project page</a></li>
                                                    <li><a href="{{url('booking.html')}}">Booking page</a></li>
                                                    <li><a href="{{url('pricing.html')}}">Pricing page</a></li>
                                            ...
                                            <li><a href="{{url('shop')}}">Shop</a>
                                                <!-- <ul>
                                                    ...
                                                    <li><a href="{{url('cart.html')}}">Shopping Cart</a></li>
                                                </ul> -->
                                            </li>
                                ...
                                <div class="col-md-1 col-sm-2 col-xs-4">
                                    <div class="search-wrap text-right">
                                        <ul>
                                            ...
                                            <li><a href="{{url('javascript:void(0);')}}"><i class="fa fa-search"></i></a>
                                                <ul>
                                                    <li>
                                                        <form action="#">
